...
<body class="tm-bg-img-content">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-xs-center">
            ...
            <p class="tm-site-description">Silahkan isi form berikut untuk menyumbangkan buku</p>
        </div>
			  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <form action="index.html" method="post" class="tm-contact-form">                                
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 tm-form-group-right">
                        	<p>Tanggal penyerahan buku</p>
                            <input type="date" id="tanggal" name="tanggal" class="form-control" placeholder="Date"  required/>
                        </div>
